###############################################################################
#   BleHealthPlotter
#       scan BLE health file in TARGET_DIR
#       for each ble health json line (sorted most recent to least)
#           read line into json structure
#           validate startTime
#           validate duration (15 mins?)
#           if entry valid
#               decode
#               detect anomalies
#               update plot info[TX]
...
#    f = open("DEMO-4119-4750-1420-weekend-22jan19.json", "r")
    filename = dir_path + "\\" + target_list[0]
...
###############################################################################
# snippets
    # #with open('DEMO-4119-4750-1420-weekend-22jan19.json') as data_file:
    # with open('test-ble.json') as data_file:
